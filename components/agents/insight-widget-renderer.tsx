...
function WidgetCard({
  ...
  return (
    <section className="rounded-[24px] border border-gray-200 bg-white p-4 text-gray-700 shadow-[0_18px_44px_-34px_rgba(15,23,42,0.28)] dark:border-gray-800 dark:bg-gray-950 dark:text-gray-100">
