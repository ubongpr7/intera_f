      ...
      <div className="old-new-way-section">
        <div className="old-way-wrapper">
          <svg width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M45 20L55 30M55 30L45 40M55 30H5" stroke="#5356FF" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" />
          </svg>
      ...
      <div id="pricing-section" className="pricing-section">
        ...
        <div className="price-card-container">
          <div className="price-card">
            <div className="price-card-description-container">
              ...
              <p className="price-card-plan-desc">Try QuickCampaigns Now Risk-Free</p>
            </div>
          ...
          <div className="price-card popular-plan">
            ...
            <div className="price-card-description-container">
              <p className="price-card-price">$99.50/month</p>
              <p className="price-card-accounts">1 Ad Account</p>
