...
export interface Attachment {
  ...
  file?: string;
  file_url?: string;
  file_type: "IMAGE" | "VIDEO" | "DOCUMENT" | "DOC" | "EXCEL" | "PDF" | "OTHER";
  purpose: "MAIN_IMAGE" | "GALLERY" | "THUMBNAIL" | "BULK_INPUT" | "BULK_REPORT" | "MANUAL" | "SPEC" | "BARCODE" | "QR_CODE";
  uploaded_by?: string;
  uploaded_by_details?: {
    id: string;
    name?: string;
...
export interface ProductInventorySummary {
  ...
  variant_stats: {
    ...
    pos_visible_variants: number;
    featured_variants: number;
  };
  category_distribution: Array<Record<string, unknown>>;
  price_analysis: {
    min_price: number;
